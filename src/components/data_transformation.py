...
import numpy as np
import pandas as pd
from sklearn.compose import ColumnTransformer ## for using Pipelines
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        This Function is resposnsible For Data Transformation
        '''
        try:
            ...
            preprocessor = ColumnTransformer([
                ...
                ('cat_piprline',cat_pipeline,categorical_columns)
            ]
            )
